...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-lg p-1 text-foreground/50 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-muted-foreground hover:text-foreground group-[.destructive]:hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-border group-[.destructive]:focus:ring-offset-background",
      className,
    )}
    toast-close=""
    {...props}
